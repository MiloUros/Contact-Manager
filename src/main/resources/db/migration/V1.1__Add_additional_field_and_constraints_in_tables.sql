...
ALTER TABLE users ADD COLUMN identifier uuid UNIQUE NOT NULL DEFAULT gen_random_uuid ();
...
ALTER TABLE contacts_types ADD COLUMN identifier uuid UNIQUE NOT NULL DEFAULT gen_random_uuid ();
...
ALTER TABLE contacts ADD COLUMN identifier uuid UNIQUE NOT NULL DEFAULT gen_random_uuid ();
